        ...
        <section style={{display: (width <= 800 && drawerVisible)  ? 'none' : 'block'}} className="filter-drawer">
            ...
            <div className="filter-category filter">
                ...
                <label htmlFor="fiction">
                    <input onChange={(e) => dispatch({ type: "CATEGORY", payload: e.target.id })} 
                    type="checkbox" 
                    id="fiction" 
                    value="fiction"
            ...
            <div className="filter-price filter">
                ...
                <label htmlFor="low-price">
                    <input onChange={() => dispatch({type:"LOWTOHIGH", payload:"lowtohigh"})} 
                    type="radio" 
                    id="low-price" 
                    value="low" 
                    name="price"
                ...
                <label htmlFor="high-price">
                    <input onChange={() => dispatch({type:"HIGHTOLOW", payload:"hightolow"})} 
                    type="radio" 
                    id="high-price" 
                    value="high" 
                    name="price"
            ...
            <div className="filter-price filter">
                <h4>In Stack</h4>
                <label htmlFor="include-outofstock">
                    <input onChange={() => dispatch({ type: "STOCKEDPRODUCTS" })} 
                    type="checkbox" 
                    id="inStock" 
                    value="low" 
                    name="inStock"
                ...
                <label htmlFor="fast-delivery">
                    <input onChange={() => dispatch({ type: "FASTDELIVERY" })} 
                    type="checkbox" 
                    id="fastDelivery" 
                    value="high" 
                    name="fastDelivery"
            ...
            <div className="filter-rating filter">
                ...
                <label htmlFor="rating-4">
                    <input onChange={(e) => dispatch({type:"RATING",payload: e.target.id })} 
                    type="radio" 
                    id="4" 
                    value="4" 
                    name="rating"
